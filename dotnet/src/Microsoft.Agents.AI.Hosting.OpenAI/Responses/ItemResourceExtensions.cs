...
public static class ItemResourceExtensions
{
    ...
    public static FunctionCallContent ToFunctionCallContent(this FunctionToolCallItemResource functionCall)
    {
        ...
        return FunctionCallContent.CreateFromParsedArguments(
            ...
            functionCall.CallId,
            functionCall.Name,
            static json => (IDictionary<string, object?>)JsonSerializer.Deserialize(json, OpenAIJsonUtilities.DefaultOptions.GetTypeInfo(typeof(IDictionary<string, object?>)))!);
    }
                ...
                case FunctionCallContent functionCallContent:
                    yield return new FunctionToolCallItemParam
                    {
                        ...
                        Arguments = JsonSerializer.Serialize(
                            ...
                            OpenAIJsonUtilities.DefaultOptions.GetTypeInfo(typeof(IDictionary<string, object?>)))
                    };
                    break;
