...
public sealed partial class WorkerDiscoveryCache
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WorkerDiscoveryCache"/> class.
    /// </summary>
        ...
        IOptions<RuntimeOptions> options)
    {
        ...
        this._logger = logger;
        this._cacheDuration = options.Value.DiscoveryCacheDuration;
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="WorkerDiscoveryCache"/> class with explicit cache duration.
    /// </summary>
    public WorkerDiscoveryCache(
        HttpClient httpClient,
        ILogger<WorkerDiscoveryCache> logger,
    ...
    /// </summary>
    public async ValueTask<IReadOnlyDictionary<string, EntityInfo>?> DiscoverEntitiesAsync(
        WorkerInfo worker,
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var discoveryResponse = await this._httpClient.GetFromJsonAsync(
                discoveryUri,
                RuntimeJsonSerializerContext.Default.DiscoveryResponse,
    ...
    /// <summary>
    /// Cached discovery result for a worker.
    /// </summary>
