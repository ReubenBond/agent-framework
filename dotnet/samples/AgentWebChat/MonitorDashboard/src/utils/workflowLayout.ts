...
import type { ExecutorNodeData } from '../components/workflow/ExecutorNode';

/**
 * Lightweight auto-layout algorithm for workflow visualization.
 * Uses BFS to assign levels and spaces nodes appropriately.
 */
export function applyWorkflowLayout(
  ...
  const HORIZONTAL_SPACING = direction === 'LR' ? 300 : 250;
  const VERTICAL_SPACING = direction === 'TB' ? 200 : 150;
