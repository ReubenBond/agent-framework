...
public sealed class Memo : Dictionary<string, string>
{
    ...
    /// <summary>
    /// Tries to get a value and parse it as a <see cref="DateTimeOffset"/>.
    /// </summary>
    /// <param name="key">The key of the element to get.</param>
    /// <param name="value">When this method returns, contains the parsed value if the key was found and could be parsed; otherwise, the default value.</param>
    /// <returns><see langword="true"/> if the key was found and the value could be parsed; otherwise, <see langword="false"/>.</returns>
    public bool TryGetDateTimeOffset(string key, out DateTimeOffset value)
    {
        if (this.TryGetValue(key, out string? stringValue) && DateTimeOffset.TryParse(stringValue, out value))
        {
            return true;
        }
    ...
    /// <summary>
    /// Tries to get a value and parse it as an <see cref="int"/>.
    /// </summary>
    /// <param name="key">The key of the element to get.</param>
    /// <param name="value">When this method returns, contains the parsed value if the key was found and could be parsed; otherwise, the default value.</param>
    /// <returns><see langword="true"/> if the key was found and the value could be parsed; otherwise, <see langword="false"/>.</returns>
    ...
    {
        if (this.TryGetValue(key, out string? stringValue) && int.TryParse(stringValue, out value))
        {
            return true;
        }
    ...
    /// <summary>
    /// Tries to get a value and parse it as a <see cref="TimeSpan"/>.
    /// </summary>
    /// <param name="key">The key of the element to get.</param>
    /// <param name="value">When this method returns, contains the parsed value if the key was found and could be parsed; otherwise, the default value.</param>
    /// <returns><see langword="true"/> if the key was found and the value could be parsed; otherwise, <see langword="false"/>.</returns>
    ...
    {
        if (this.TryGetValue(key, out string? stringValue) && TimeSpan.TryParse(stringValue, out value))
        {
            return true;
        }
    ...
    /// <summary>
    /// Gets a value and parses it as a <see cref="DateTimeOffset"/>, or returns a default value if the key is not found or cannot be parsed.
    /// </summary>
    /// <param name="key">The key of the element to get.</param>
    /// <param name="defaultValue">The default value to return if the key is not found or cannot be parsed.</param>
    /// <returns>The parsed value if the key was found and could be parsed; otherwise, the default value.</returns>
    public DateTimeOffset GetDateTimeOffsetOrDefault(string key, DateTimeOffset defaultValue = default)
    {
        return this.TryGetDateTimeOffset(key, out DateTimeOffset value) ? value : defaultValue;
    }

    /// <summary>
    /// Gets a value and parses it as an <see cref="int"/>, or returns a default value if the key is not found or cannot be parsed.
    /// </summary>
    /// <param name="key">The key of the element to get.</param>
    /// <param name="defaultValue">The default value to return if the key is not found or cannot be parsed.</param>
    /// <returns>The parsed value if the key was found and could be parsed; otherwise, the default value.</returns>
    ...
    {
        return this.TryGetInt32(key, out int value) ? value : defaultValue;
    }

    /// <summary>
    /// Increments an integer value in the memo, or initializes it to 1 if it doesn't exist.
    /// </summary>
    /// <param name="key">The key of the counter to increment.</param>
    /// <returns>The new value after incrementing.</returns>
    public int Increment(string key)
    {
        int newValue = this.GetInt32OrDefault(key, 0) + 1;
        this[key] = newValue.ToString();
        return newValue;
    }

    /// <summary>
    /// Decrements an integer value in the memo, or initializes it to -1 if it doesn't exist.
    /// </summary>
