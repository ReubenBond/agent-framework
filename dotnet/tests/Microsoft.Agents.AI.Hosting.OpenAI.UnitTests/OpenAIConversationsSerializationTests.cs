...
public sealed class OpenAIConversationsSerializationTests
{
    ...
    public void Deserialize_CreateConversationRequest_Success()
    {
        ...
        // Act
        CreateConversationRequest? request = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.CreateConversationRequest);
    ...
    public void Deserialize_CreateConversationWithItems_Success()
    {
        ...
        Assert.True(request.Items.Length > 0);
    }
    ...
    public void Deserialize_CreateItemsRequest_Success()
    {
        ...
        // Act
        CreateItemsRequest? request = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.CreateItemsRequest);
    ...
    public void Deserialize_UpdateConversationRequest_Success()
    {
        ...
        // Act
        UpdateConversationRequest? request = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.UpdateConversationRequest);
    ...
    public void Serialize_CreateConversationRequest_MatchesFormat()
    {
        ...
        // Act
        string json = JsonSerializer.Serialize(request, OpenAIJsonContext.Default.CreateConversationRequest);
    ...
    public void Deserialize_Conversation_Success()
    {
        ...
        // Act
        Conversation? conversation = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.Conversation);
    ...
    public void Deserialize_ConversationRoundTrip_PreservesData()
    {
        ...
        Conversation? conversation = JsonSerializer.Deserialize(originalJson, OpenAIJsonContext.Default.Conversation);
        string reserializedJson = JsonSerializer.Serialize(conversation, OpenAIJsonContext.Default.Conversation);
        Conversation? roundtripped = JsonSerializer.Deserialize(reserializedJson, OpenAIJsonContext.Default.Conversation);
    ...
    public void Deserialize_ItemListResponse_Success()
    {
        ...
        ListResponse<ItemResource>? response = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.ListResponseItemResource);
    ...
    public void Deserialize_ItemResource_Success()
    {
        ...
        // Act
        ItemResource? item = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.ItemResource);
    ...
    public void Deserialize_DeleteResponse_Success()
    {
        ...
        // Act
        DeleteResponse? response = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.DeleteResponse);
    ...
    public void Deserialize_ErrorResponse_Success()
    {
        ...
        // Act
        ErrorResponse? response = JsonSerializer.Deserialize(json, OpenAIJsonContext.Default.ErrorResponse);
    ...
    public void Serialize_Conversation_MatchesFormat()
    {
        ...
        // Act
        string json = JsonSerializer.Serialize(conversation, OpenAIJsonContext.Default.Conversation);
        using var doc = JsonDocument.Parse(json);
        var root = doc.RootElement;
    ...
    public void Serialize_ConversationListResponse_MatchesFormat()
    {
        ...
        // Act
        string json = JsonSerializer.Serialize(response, OpenAIJsonContext.Default.ConversationListResponse);
        using var doc = JsonDocument.Parse(json);
        var root = doc.RootElement;
    ...
    public void Serialize_DeleteResponse_MatchesFormat()
    {
        ...
        // Act
        string json = JsonSerializer.Serialize(response, OpenAIJsonContext.Default.DeleteResponse);
        using var doc = JsonDocument.Parse(json);
        var root = doc.RootElement;
    ...
    public void Serialize_ErrorResponse_MatchesFormat()
    {
        ...
        // Act
        string json = JsonSerializer.Serialize(response, OpenAIJsonContext.Default.ErrorResponse);
        using var doc = JsonDocument.Parse(json);
        var root = doc.RootElement;
